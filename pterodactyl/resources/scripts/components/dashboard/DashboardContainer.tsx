...
<a href="https://wa.me/6285263390832?text=kak+Mau+Order+Hosting+Minecraft">ORDER</a>
                    </div>
                    <div className="tarif">
                        <img src="/themes/enigma_premium/img/gta_logo.png" alt="" />
                        <h2>GTA</h2>
                        <p>You can rent a GTA server on our hosting</p>
                        <a href="https://wa.me/6285263390832?text=kak+Mau+Order+Hosting+GTA">ORDER</a>
                    </div>
                    <div className="tarif">
                        <img style={{borderRadius:'10px'}} src="/themes/enigma_premium/img/rust_logo.jpeg" alt="" />
                        <h2>BOT</h2>
                        <p>You can rent a Rust Hosting on our hosting</p>
                        <a href="https://wa.me/6285263390832?text=kak+Mau+Order+rust+Hosting">ORDER</a>
                    </div>
                    <div className="tarif">
                        <img style={{borderRadius:'10px'}} src="/themes/enigma_premium/img/csgo_logo.jpg" alt="" />
                        <h2>CSGO</h2>
                        <p>You can rent a CSGO server on our hosting</p>
                        <a href="https://wa.me/6285263390832?text=kak+Mau+Order+csgo+Hosting">ORDER</a>
                    </div>
                </div>
                <h2>Your servers</h2>
            ...
            <iframe src="https://discord.com/widget?id=8967368018075607⁹⁹54&theme=dark" width="100%" height="350" allowTransparency={true} frameBorder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
            </div>
            <div className="clear"></div>
        </PageContentBlock>
    );
